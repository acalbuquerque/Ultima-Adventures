	...
	public class ClumsySpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				m.FixedParticles( 0x3779, 10, 15, 5002, Server.Items.CharacterDatabase.GetMySpellHue( Caster, 0 ), 0, EffectLayer.Head );
				m.PlaySound( 0x1DF );
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget( ClumsySpell owner ) : base( Core.ML ? 12 : 14, false, TargetFlags.Harmful )
			{
				m_Owner = owner;
			}
