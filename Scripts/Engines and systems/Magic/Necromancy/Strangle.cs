	...
	public class StrangleSpell : NecromancerSpell
	{
		...
		public void Target( Mobile m )
		{
			if ( CheckHSequence( m ) )
			{
				 ...
				 * Example:
				 * For a target at full Stamina the damage multiplier is 1, // final: changing this to 2
				 * for a target at 50% Stamina the damage multiplier is 2 and // final: changing this to 4
				 * for a target at 20% Stamina the damage multiplier is 2.6 // final: changing this to 10
				 */
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer( Mobile target, Mobile from ) : base( TimeSpan.FromSeconds( 0.1 ), TimeSpan.FromSeconds( 0.1 ) )
			{
				...
				{
					nBenefit = (int)(from.Skills[SkillName.Necromancy].Value / 20);
				}
			...
			protected override void OnTick()
			{
				...
				else
				{
					...
					damage *= (10 - (((double)m_Target.Stam / m_Target.StamMax) * 9));
					//Final:  now 10x at 0 stam, 5.5x at 50%, and 1x at full stam
